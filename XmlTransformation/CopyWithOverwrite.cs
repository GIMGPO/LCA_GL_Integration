...
{
    public class CopyWithOverwrite: TransformBase
    {
        ...
        public CopyWithOverwrite(XmlDocument doc, Transform transform, RunMode runMode, Hashtable htmlEntities, NamespaceManagerHelper nsmh, XmlDocument configDoc, Hashtable values)
